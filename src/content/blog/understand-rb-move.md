...
The above map shows Verstappen (Left) vs Lawson (Right) on their fast lap in qualifying (Red - Yellow - Blue = Slow - Med - Fast). While identical, there are a few areas where the slow speed regions are slightly more expanded than on Verstappens, such as turns 9-10. Verstappen is also quicker to ramp up to speed on the straights.
