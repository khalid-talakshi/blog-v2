  ...
  return (
    <div className='flex flex-col gap-2'>
      <div className='flex gap-2 w-full rounded-xl text-sm px-2 py-1'>
        <div onClick={zoomOut} className='hover:cursor-pointer hover:text-gray-400 transition ease-in-out duration-75'><FaMagnifyingGlassMinus /></div>
      </div>
      <LineChart style={{ width: '100%', aspectRatio: 1.618 }} responsive onMouseDown={onMouseDown} onMouseUp={zoom} onMouseMove={onMouseMove}>
